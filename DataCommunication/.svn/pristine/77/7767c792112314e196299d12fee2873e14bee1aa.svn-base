<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MainMaster.Master" AutoEventWireup="true" CodeBehind="AccidentReport.aspx.cs" Inherits="SummitShopApp.AccidentReport" %>
